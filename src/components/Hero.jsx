  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-3`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold sm:text-[72px] text-[52px] text-white leading-[75px] sm:leading-[100px]">
      ...
      <h1 className="font-poppins font-semibold ss:text-[68px] text-[48px] text-white leading-[75px] ss:leading-[100px]">
        Payment Method
      </h1>
